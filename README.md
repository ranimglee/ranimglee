...
| Domain | Technologies |
| --- | --- |
| Backend | Java, Spring Boot, Symfony, PHP, REST APIs, microservices concepts |
| Frontend | Angular, React, Next.js, TypeScript, JavaScript, HTML/CSS |
| Databases | PostgreSQL, MySQL |
| DevOps | Docker, Docker Compose, Jenkins, CI/CD pipelines, SonarQube, Nexus, Prometheus, Grafana, Linux, Git/GitHub |
| Cloud | AWS basics, Kubernetes concepts, OVH Cloud deployment experience |
| AI & Productivity | Generative AI assisted development, Claude, Codex, AI-powered engineering workflows |
